...
def test_agent_pipeline():
    ...
    cases = [
        ...
        ("analyst", "Analyze NVIDIA, compare it with Apple, and create an investment memo"),
        ("analyst", "Analyze NVIDIA, show its P/E ratio, and create an investment memo"),
        ("analyst", "Create an investment memo for NVIDIA"),
        ("analyst", "Tell me about NVIDIA and tell me a joke"),
        ("analyst", "Compare NVIDIA and Apple, then help me plan my vacation"),
        ("analyst", "Tell me a joke"),
        ("manager", "Review the pending NVIDIA investment memo"),
        ("manager", "Review the NVIDIA memo and tell me whether it should be approved"),
        ("manager", "Review the Apple memo and answer my follow-up questions"),
